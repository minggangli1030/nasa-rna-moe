...
Latest update (September 15): the [radiation robustness audit](runs/07_radiation_robustness_audit_2026-09-15/REPORT.md)
is complete. Common-count processing supports a narrow 2Gy/24h IMR90 transfer lead;
chemical-stress specificity and cross-cell transport remain inadequate. Keep that head
as a research comparator. Next validate matched tissue/time exposure responses and their
signed contribution to the flight head together. The new challenge was head-held-out but
present in the encoder catalog; seek independent donors/experiments for confirmation.
Do not interpret its sigmoid as exposure probability or causal contribution. See [status](STATUS.md).
