...
Latest update: [controlled-exposure validation](runs/06_controlled_exposure_validation_2026-09-14/REPORT.md)
is complete. Radiation-associated heads were tested with whole-file holdouts, non-radiation
stress challenges and an independent lung-chip study. Results support continued concept
validation, not a deployed radiation detector. The next priority is controlled-gravity
quantification and tissue-matched response validation; see [current status](STATUS.md).
