...
The authorized [spaceflight prediction-head pilot](artifacts/space_head_pilot_2026-09-14/REPORT.md)
is complete. On 24 human muscle-chip profiles from two flights, frozen BridgeRNA heads
perform much better within flights but fail cross-flight transfer (balanced accuracy
0.500, AUROC 0.000 in both directions at C=1); expression/PCA fail transfer too.
[Results figure](artifacts/space_head_pilot_2026-09-14/pilot_results.pdf).
No encoder tuning or BridgeRNA gene attribution was justified by this pilot; nothing is running.
...
(unassigned). Further experiments are not queued. See [Minggang's plan](docs/2026-09-14-SPACE-PREDICTION-HEAD-PLAN.md)
and [next steps](NEXT-STEPS.md) for the remaining scientific decision.
