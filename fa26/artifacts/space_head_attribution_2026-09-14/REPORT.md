# Experiment-specific gene attribution — September 14, 2026

**Completed input-gene attribution for the frozen GSE298393 muscle-chip classifier.**
The analysis identifies 44 genes meeting the stated descriptive stability filter
...
absolute completeness residual was 6.93659e-05 logit units;
maximum relative L1 change after increasing integration resolution was
0.000%. Input gradients were checked against central
finite differences at three influential genes for each head; the maximum relative
error was 0.596%. Reconstructed sample scores
matched the saved fitted-head scores within 4.09e-13.
...
| Gene | Contribution to flight−ground score gap | Sign retained after chip deletion | Gene annotation |
|---|---:|---:|---|
| MUSK | +0.5071 | 100% | muscle associated receptor tyrosine kinase |
| USF1 | +0.5046 | 100% | upstream transcription factor 1 |
| SETD7 | +0.5017 | 100% | SET domain containing 7, histone lysine methyltransferase |
| BGN | +0.3713 | 100% | biglycan |
| RGS14 | +0.2791 | 100% | regulator of G protein signaling 14 |
| HNRNPR | +0.2450 | 100% | heterogeneous nuclear ribonucleoprotein R |
| FBXO4 | +0.2321 | 100% | F-box protein 4 |
| ADIPOR1 | -0.2291 | 100% | adiponectin receptor 1 |
| ITGA7 | +0.2181 | 100% | integrin subunit alpha 7 |
| DPM1 | +0.1735 | 100% | dolichyl-phosphate mannosyltransferase subunit 1, catalytic |
| PRPF19 | +0.1705 | 100% | pre-mRNA processing factor 19 |
| WSCD1 | +0.1686 | 100% | WSC domain sialate O sulfotransferase 1 |
| TEAD4 | -0.1650 | 100% | TEA domain transcription factor 4 |
| GTPBP4 | -0.1581 | 100% | GTP binding protein 4 |
| CAP2 | +0.1561 | 100% | cyclase associated actin cytoskeleton regulatory protein 2 |
...
correlations of 0.996–0.996; changing the pool/head
(with either reference) gave 0.416–0.431.
Top-100 overlap across pool/head cases was 45–46
...
signed response correlations were 0.086–0.114,
with 2–3 shared top-100 genes.
...
For BridgeRNA top-100 panels, median signed movement was 3.5589
logit units, versus a median of 0.0577 for matched controls.
The top panel exceeded the matched-random median in 12/12 chips.
The median fraction of random panels with smaller signed movement was
100.0%. These are descriptive faithfulness checks,
...
| Hallmark gene set | Mean absolute contribution per member gene | Signed sum range across cases |
|---|---:|---:|
| Epithelial Mesenchymal Transition | 0.01292 | +0.964 to +1.175 |
| Myogenesis | 0.01219 | +0.581 to +0.769 |
| Hedgehog Signaling | 0.01023 | -0.052 to +0.173 |
| Apoptosis | 0.01003 | +0.227 to +0.725 |
| Myc Targets V1 | 0.00980 | +0.093 to +0.519 |
| UV Response Dn | 0.00977 | +0.610 to +0.806 |
| Angiogenesis | 0.00928 | +0.038 to +0.084 |
| Hypoxia | 0.00840 | +0.344 to +0.745 |
| Androgen Response | 0.00821 | -0.015 to +0.370 |
| Apical Junction | 0.00795 | +0.259 to +0.537 |
...
A100 runtime: 13.6 minutes; peak allocated GPU memory:
4.24 GB. The isolated directory is
