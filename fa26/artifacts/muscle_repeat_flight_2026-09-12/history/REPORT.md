...
**Next:** compare the non-stimulated arms of the later flight, **GSE298393**, before exploring age-related mechanisms. That follow-up study reports a ground run in the same CubeLab hardware; it still is not independent donor validation. It was identified from the publication after this screen and has **not** been analyzed here. [Follow-up study and data accession](https://pmc.ncbi.nlm.nih.gov/articles/PMC12277833/).
