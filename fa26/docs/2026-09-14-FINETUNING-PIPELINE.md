...
> Ownership update: use the [meeting notes](2026-09-14-MEETING-NOTES.md) and
> [Minggang's spaceflight-head plan](2026-09-14-SPACE-PREDICTION-HEAD-PLAN.md).
> Batch/contrastive learning belongs to Brain; spaceflight prediction and attribution
> belong to Minggang; human versus mouse is a third, unassigned task. The initial head
> baseline need not wait for correction. This earlier combined proposal is retained as
> technical background. Current instruction: documentation only; do not execute.
