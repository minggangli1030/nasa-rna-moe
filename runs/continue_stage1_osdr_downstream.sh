...
EXECUTION="$ROOT/artifacts/final_evaluation/stage1_osdr_downstream/execution_v5.json"
...
FEATURES="$RESULT/features_v4"
SMOKE="$RESULT/evaluation_smoke_v5"
FULL="$RESULT/evaluation_full_v5"
