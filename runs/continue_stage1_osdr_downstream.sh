...
EXECUTION="$ROOT/artifacts/final_evaluation/stage1_osdr_downstream/execution_v2.json"
...
FEATURES="$RESULT/features_v2"
SMOKE="$RESULT/evaluation_smoke_v2"
FULL="$RESULT/evaluation_full_v2"
